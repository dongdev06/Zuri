...
function startBot(message) {
    ...
    const child = spawn("node", ["--trace-warnings", "--async-stack-traces", "zuri-main.js"], {
        cwd: __dirname,
        stdio: "inherit",
        shell: true
    });
...
axios.get('https://raw.githubusercontent.com/dongdev06/Zuri/master/package.json').then((res) => {
